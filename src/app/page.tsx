...
// import type { MusicRNN, SoundFontPlayer } from '@magenta/music/es6';
// import type { INoteSequence } from '@magenta/music/es6/core';
...
//       try {
//         const music = await import('@magenta/music/es6');
//         musicLibRef.current = music;

//         const rnn = new music.MusicRNN('https://storage.googleapis.com/magentadata/js/checkpoints/music_rnn/basic_rnn');
//         await rnn.initialize();
//         musicRnnRef.current = rnn;

//         const sfPlayer = new music.SoundFontPlayer(
...
//         const progress = (currentTime / generatedSequence.totalTime) * 100;
...
//         const offset = generatedSequence.totalTime * (progress / 100);
...
//     const seekTime = (generatedSequence.totalTime * clampedProgress) / 100;
...
//     if (!generatedSequence) return;
//     const { totalTime } = generatedSequence;
...
//     try {
//       const midiData = musicLibRef.current.core.noteSequenceToMidi(generatedSequence);
//       const blob = new Blob([midiData], { type: 'audio/midi' });
//       const url = URL.createObjectURL(blob);
//       const a = document.createElement('a');
//       a.href = url;
//       a.download = `hashnotes-track-${Date.now()}.mid`;
...
//         variant: 'destructive',
//         title: 'Download Error', 
//         description: 'Failed to download MIDI file.' 
//       });
//     }
//   };
...
//   const currentTime = useMemo(() => (totalTime * playbackState.progress) / 100, [totalTime, playbackState.progress]);
...
//           <h1 className="font-headline text-2xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">HashNotes</h1>
